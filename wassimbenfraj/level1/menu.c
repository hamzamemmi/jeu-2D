...
void initialiser (Objet *newgame,Objet *loadgame ,Objet *settings,Objet *icon,Objet *in_sound ,Objet *in_sound25,Objet *in_sound50,Objet *in_sound75,Objet *in_sound100,Objet *in_settings,Objet *credits,Objet *main_menu ,Objet *quitter,Objet *wexit,Objet *nwexit ,Objet *exxit,Objet *game,Objet *map,Objet *box,Objet *boat,Objet tabD [],Objet tabG [],Objet ennemi [],Objet ennemiD [],Objet vie [],Objet *mask)
{
  ...
  box->img=IMG_Load("persoG/walk6.png") ;
  box->pos.x=xwood ;
  box->pos.y=ywood ;
      ...
      *running = 0;
      ...
      case SDL_KEYDOWN:
           ...
           *quitt=1 ;
           break ; 
           case SDLK_RETURN:
               clic_entrer_menu_principale (screen ,in_settings,*icon,effect,*curseur,&in,running,quitt,exxit,transition ) ;
           break ;
           case SDLK_DOWN :
