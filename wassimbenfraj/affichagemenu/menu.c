...
void initialiser (Objet *newgame,Objet *loadgame ,Objet *settings,Objet *icon,Objet *in_sound ,Objet *in_sound25,Objet *in_sound50,Objet *in_sound75,Objet *in_sound100,Objet *in_settings,Objet *credits,Objet *main_menu ,Objet *quitter,Objet *wexit,Objet *nwexit ,Objet *exxit,Objet *game,Objet *map,Objet *wood,Objet *boat)
{
  ...
  map->img= IMG_Load("map_Plan de travail 1.png") ;
  map->pos.x=0 ;
  map->pos.y=0 ;
  map->pos.w=width ;
  map->pos.h=height ;
...
int deplacementmenu_up_down(SDL_Surface *screen, SDL_Event event ,int *firsttime,int *curseur,int *running,Objet newgame,Objet loadgame,Objet settings ,Objet quitter ,Objet *icon,Objet in_settings , Mix_Chunk *effect,int *boolean_icon,int *quitt,Objet exxit,Objet tab [],int *transition)
{
    ...
    switch (event.type)
    {
      ...
      *running = 0;
      ...
      case SDL_MOUSEBUTTONDOWN:
           clic_souris_menu_principale (screen,event, *curseur ,newgame,loadgame,settings,in_settings,icon,quitter,&in,running,boolean_icon,quitt,exxit,tab,transition) ;                   
      break;
